...
/*TMODJS:{"version":1,"md5":"80a0de39b362dc9d0816072decff60aa"}*/
var template=require("../../../template");module.exports=template("demo/assemble/views/tpl.list",'<stub></stub> <list card="card" name="name" value="123" :data="list" :on-tap="onTap"> </list> <stub></stub> <list card="card" :data="list" :on-tap="onTap"> </list>');
